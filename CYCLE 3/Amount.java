...
public class Amount
{
    ...
    {
        System.out.print("course_name:OOP LAB");
        System.out.print("Course_code:20MCA132");
        System.out.print("  Name     : Aparna Jayakumar");
        System.out.print("Register_no: SJC22MCA-2012");
        System.out.print("Date       :07/06/2023");
        int n,i;
        double namount=0,t;
        int ran;
        String date;
